🌐 **English** · [中文](https://oddfi.gitbook.io/oddfi-docs-zh/) · [日本語](https://oddfi.gitbook.io/oddfi-docs-ja/) · [한국어](https://oddfi.gitbook.io/oddfi-docs-ko/)
...
1. [What is OddFi](#1-what-is-oddfi)
2. [Getting Started](#2-getting-started)
3. [World Cup Playbook](#3-world-cup-playbook)
4. [Deposit & Withdrawal](#4-deposit--withdrawal)
5. [Liquidity Provision (Market Making)](#5-liquidity-provision-market-making)
6. [ODD Staking](#6-odd-staking)
7. [Position Lending](#7-position-lending)
8. [Referral Rewards](#8-referral-rewards)
9. [ODD Tokenomics](#9-odd-tokenomics)
10. [Fees & Security](#10-fees--security)
11. [FAQ](#11-faq)
...
OddFi is a decentralized sports prediction market deployed on the BNB Smart Chain (BSC). Connect your wallet and you're in — no registration, no email, no KYC. All funds are self-custodied.
...
| Dimension | OddFi | Traditional Platform |
|---|---|---|
| Account | Wallet connect only | Email + KYC + identity verification |
